  ...
  return (
    <AppLayout title="Vendas">
      <div className="flex items-center justify-between mb-4">
        <div>
          <h1>Vendas</h1>
          <p className="text-muted text-sm mt-1">Registro de vendas de produtos</p>
        </div>
      ...
      <div className="card">
        {loading ? (
          ...
          <div className="table-wrap">
            <table>
              <thead>
                <tr><th>Produto</th><th>Centro</th><th>Quantidade</th><th>Valor Unit.</th><th>Valor Total</th><th>Observacao</th><th>Usuario</th><th>Data</th><th></th></tr>
              </thead>
              <tbody>
                {vendas.map(v => (
                  <tr key={v.id}>
                    ...
                    <td>
                      <div>{v.centros?.nome}</div>
                      <div className="text-xs text-muted">{v.centros?.estoques?.nome}</div>
                    </td>
                    ...
                    <td>
                      <button className="btn btn-danger btn-sm" onClick={() => remover(v.id)}>Remover</button>
                    </td>
                  </tr>
                ))}
              </tbody>
            ...
            <div className="modal-body">
              ...
              <div className="field">
                ...
                <input
                  ...
                  type="text"
                  readOnly
                  value={valorTotal > 0 ? 'R$ ' + valorTotal.toFixed(2).replace('.', ',') : '-'}
